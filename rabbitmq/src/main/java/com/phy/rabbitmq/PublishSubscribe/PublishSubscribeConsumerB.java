package com.phy.rabbitmq.PublishSubscribe;

import com.phy.rabbitmq.until.RabbitConnectionUtil;
...
public class PublishSubscribeConsumerB {
    private static Logger logger = LoggerFactory.getLogger(PublishSubscribeConsumerB.class);
